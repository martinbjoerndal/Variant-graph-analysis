...
popsInitial = list(brit, fin, luhya, yoruba, hanBei, hanSouth)
pops = cleanForBF(popsInitial)
...
# Write to file
write.table(distanceTable, file = "./5000Lines/distanceTableBubblesExcluded.txt")
